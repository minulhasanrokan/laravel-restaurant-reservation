          ...
          <div class="col-xl-12">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              ...
              <div class="row mg-t-20">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input name="guest_number" type="number" class="form-control" placeholder="Table Guest Number">
                </div>
              </div><!-- row -->
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Table Description: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <textarea name="description" rows="2" class="form-control" placeholder="Enter your address"></textarea>
                </div>
              </div>
              <div class="row mg-t-20">
              ...
              <div class="form-layout-footer mg-t-30">
                <button  style="float: right !important;" class="btn btn-info mg-r-5">Create Table</button>
