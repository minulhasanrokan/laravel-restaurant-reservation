...
return window.confirm("Close window 1?")
  ...
  <div class="sl-pagebody">
    <div class="row">
      ...
      <div class="col-sm-6 col-md-2">
        <a href="{{route('admin.menus.create')}}"><button class="btn btn-primary btn-block mg-b-10"><i class="fa fa-recycle"></i> Create Menu</button></a>
      </div><!-- col-sm -->
    </div><!-- row -->
              ...
              <form method="POST" action="{{route('admin.menus.update',$menu->id)}}" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input value="{{$menu->name}}" name="name" type="text" class="form-control" placeholder="Enter Menu Name">
                  </div>
                </div><!-- row -->
                <div class="row mg-t-20">
                  <label class="col-sm-4 form-control-label">Menu Description: <span class="tx-danger">*</span></label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <textarea name="description" rows="2" class="form-control">{{$menu->description}}</textarea>
                  </div>
                </div>
                <div class="row mg-t-20">
                  <label class="col-sm-4 form-control-label">Menu Category: <span class="tx-danger">*</span></label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input value="{{$menu->price}}" name="price" type="number" class="form-control" placeholder="Enter Menu Price">
                  </div>
                </div><!-- row -->
                <div class="form-layout-footer mg-t-30">
                  <button  style="float: right !important;" class="btn btn-info mg-r-5">Update</button>
